...
- Pass the `summary` verbatim to `HassListRemoveItem.item` — **including any emoji prefix and quantity suffix** (e.g. `🥛 lactose-free milk`, not `lactose-free milk`; `🥩 beef — 300 g`, not `beef`).
